const Buttons = ({handleclick, quote, author}) => (
    <div className="buttons pt-4 d-flex justify-content-around">
        ...
        <a href={`http://www.twitter.com/intent/tweet?text=${quote} --${author}`} target="_blank" rel="noreferrer" className="btn btn-dark"><i className="fab fa-twitter-square"></i> Tweet</a>
    </div>
);
